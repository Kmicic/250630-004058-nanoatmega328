...
// void smartArrow(bool state = true); // forward declaration for smartArrow
// function
...
// void redrawMainSettings(); // forward declaration for redrawMainSettings
// function
...
void drawArrow(); // forward declaration for drawArrow function
//void smartArrow(bool state = true); // forward declaration for smartArrow function
...
void controlTick(); // forward declaration for controlTick function
...
bool isSpace(byte col, byte row); // forward declaration for isSpace function
